...
**Última atualização:** 2026-06-18 (add-coach-attention-queue mergeado e arquivado; sprint 9 parcial ✅)
...
| 9 | ~~`add-coach-attention-queue`~~ ✅ + `add-recommendation-explainability` *(visível)* | 13 + 9 | Fila de atenção on-demand (mergeada 2026-06-18) + camada de explicabilidade (próxima). Hook diário do treinador. | shell-dashboards |
