...
- [x] 5.3 **Feito.** PR [menthoros-backend#135](https://github.com/llsilvas/menthoros-backend/pull/135)
      mergeado em `develop` (2026-09-18) — `use-best-effort-for-threshold-inference` destravada.
