...
- [~] 7.2 Verificação manual no browser — **adiada**: requer backend local rodando com Keycloak + dados de atenção reais. Validar durante a integração com `add-coach-suggestion-inbox` (Sprint 9c), que cobre o mesmo fluxo end-to-end.
